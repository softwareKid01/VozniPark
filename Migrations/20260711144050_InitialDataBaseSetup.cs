        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RegistracijskaOznaka = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TipServisa = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    OpisRadova = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
                    ServisnaKuca = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    Cijena = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
                    Napomena = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true)
                },
                constraints: table =>
                {
